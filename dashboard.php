...
if(permission_checker_boolean('admin')){
    $adminFunctions = "<p><a href='usermanagement.php' class='btn btn-dark'>Userverwaltung</a><a href='diensttypverwaltung.php' class='btn btn-dark ml-3'>Diensttypen verwalten</a></p>";
} else {
    $adminFunctions = "";
}
